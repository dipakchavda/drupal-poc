...
/**
 * @file
 * Contains \Drupal\nestle_contactlab_rules\Plugin\RulesAction\AfterCreateNewUser.
 */
 ...
 *
 * @RulesAction(
 *   id = "after_create_new_user_action",
 *   label = @Translation("Show a message after save nestle node."),
 ...
 */
class AfterCreateNewUser extends RulesActionBase {
  /**
