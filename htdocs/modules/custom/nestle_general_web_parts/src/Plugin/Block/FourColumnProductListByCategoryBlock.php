...
/**
 * Provides a 'Four Column Product List By Category Block' Block.
 *
 * @Block(
 *   id = "four_col_prods_block",
 *   admin_label = @Translation("Four Column Product List By Category Block"),
 *   category = @Translation("Nestle"),
 * )
 */
class FourColumnProductListByCategoryBlock extends BlockBase {
